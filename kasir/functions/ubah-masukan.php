...
if ( !isset($_SESSION["login"]) ) {
  ...
  exit;
    ...
    $id = $_GET["id"];
    $masukan = query("SELECT * FROM box_pesan WHERE id = $id")[0];
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="../index.php#menu">Memesan</a></li>
          <li><a href="#">Memesan Meja</a></li>
          <li><a href="#">Transaksi</a></li>
          <li><a href="#">Laporan</a></li>
          <li><a href="input-masukan">Pesan</a></li>
      ...
      <a class="btn-book-a-table" href="../login system/logout.php">Logout</a>
